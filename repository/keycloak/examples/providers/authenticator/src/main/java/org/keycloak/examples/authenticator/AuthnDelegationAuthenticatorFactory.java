...
public class AuthnDelegationAuthenticatorFactory implements AuthenticatorFactory, ConfigurableAuthenticatorFactory {
    ...
    static {
        ...
        property.setLabel("HTTP FORM POST for fowarding parameters");
        property.setType(ProviderConfigProperty.BOOLEAN_TYPE);
        property.setDefaultValue(true);
        property.setHelpText("Conduct HTTP FORM POST to forward parameters to anexternal authentication server. If Off, conduct HTTP redirect instead.");
        configProperties.add(property);
    }
